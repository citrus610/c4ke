...
i32 CORRHIST_WEIGHT_PAWN = 137;
i32 CORRHIST_WEIGHT_NONPAWN = 208;
i32 CORRHIST_WEIGHT_CONT_1PLY = 140;
i32 CORRHIST_WEIGHT_CONT_2PLY = 205;
i32 RFP_COEF = 66;
...
i32 FP_HIST_DV = 32;
i32 SEEP_COEF = 81;
i32 SE_DEXT_MARGIN = 13;
double LMR_COEF = 0.35;
double LMR_BASE = 1.0;
i32 LMR_HIST_DIV = 7792;
i32 HIST_BONUS_COEF = 157;
i32 HIST_BONUS_BASE = -54;
i32 HIST_BONUS_MAX = 1485;
i32 HIST_FAIL_COEF = 150;
i32 ASP_DELTA = 10;
double ASP_GROWTH = 1.5;
i32 VALUE_PAWN = 110;
i32 VALUE_KNIGHT = 319;
i32 VALUE_BISHOP = 294;
i32 VALUE_ROOK = 518;
i32 VALUE_QUEEN = 912;
double TM_SOFT = 0.05;
double TM_HARD = 0.5;
double TM_BM_MAX = 2.0;
double TM_BM_COEF = 1.5;

// CORRHIST_WEIGHT_PAWN, int, 137.0, 50.0, 500.0, 20.0, 0.002
// CORRHIST_WEIGHT_NONPAWN, int, 208.0, 50.0, 500.0, 20.0, 0.002
// CORRHIST_WEIGHT_CONT_1PLY, int, 140.0, 50.0, 500.0, 20.0, 0.002
// CORRHIST_WEIGHT_CONT_2PLY, int, 205.0, 50.0, 500.0, 20.0, 0.002
// RFP_COEF, int, 66.0, 20.0, 200.0, 8.0, 0.002
// NMP_BETA_MARGIN, int, 25.0, 10.0, 100.0, 2.5, 0.002
// CONTHIST_1PLY, float, 2.0, 1.0, 4.0, 0.2, 0.002
// CONTHIST_2PLY, float, 2.0, 1.0, 4.0, 0.2, 0.002
// FP_COEF, int, 96.0, 50.0, 500.0, 10.0, 0.002
// FP_BASE, int, 100.0, 50.0, 500.0, 10.0, 0.002
// FP_HIST_DV, int, 32.0, 20.0, 500.0, 2.0, 0.002
// SEEP_COEF, int, 81.0, 20.0, 500.0, 8.0, 0.002
// SE_DEXT_MARGIN, int, 13.0, 2.0, 32.0, 1.0, 0.002
// LMR_COEF, float, 0.35, 0.25, 1.0, 0.03, 0.002
// LMR_BASE, float, 1.0, 0.5, 2.0, 0.1, 0.002
// LMR_HIST_DIV, int, 7792.0, 2000.0, 12000.0, 512.0, 0.002
// HIST_BONUS_COEF, int, 157.0, 50.0, 500.0, 15.0, 0.002
// HIST_BONUS_BASE, int, -54.0, -500.0, 500.0, 10.0, 0.002
// HIST_BONUS_MAX, int, 1485.0, 1000.0, 2500.0, 150.0, 0.002
// HIST_FAIL_COEF, int, 150.0, 50.0, 500.0, 15.0, 0.002
// ASP_DELTA, int, 10.0, 8.0, 16.0, 1.0, 0.002
// ASP_GROWTH, float, 1.5, 1.1, 3.0, 0.1, 0.002
// VALUE_PAWN, int, 110.0, 50.0, 200.0, 10.0, 0.002
// VALUE_KNIGHT, int, 319.0, 250.0, 500.0, 20.0, 0.002
// VALUE_BISHOP, int, 294.0, 250.0, 500.0, 20.0, 0.002
// VALUE_ROOK, int, 518.0, 400.0, 800.0, 40.0, 0.002
// VALUE_QUEEN, int, 912.0, 800.0, 2000.0, 80.0, 0.002
// TM_SOFT, float, 0.05, 0.02, 0.1, 0.005, 0.002
// TM_HARD, float, 0.5, 0.2, 0.8, 0.05, 0.002
// TM_BM_MAX, float, 2.0, 1.8, 3.0, 0.2, 0.002
// TM_BM_COEF, float, 1.5, 1.0, 1.8, 0.15, 0.002